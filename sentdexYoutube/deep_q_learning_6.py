'''
@Description: Deep Q-learning part 2
@Author: Jack Huang
@Github: https://github.com/HuangJiaLian
@Date: 2019-09-04 09:30:45
@LastEditors: Jack Huang
@LastEditTime: 2019-09-05 15:38:27
'''
...
class DQNAgent:
    ...
    def train(self, terminal_state, step):
        ...
        # target_model会比较稳定，相比basic, model
        ...
        for index, (current_states,action,reward,new_current_states,done) in enumerate(minibatch):
            ...
            X.append(current_states) # 类似图片
            y.append(current_qs) # 类似图片对应的label
